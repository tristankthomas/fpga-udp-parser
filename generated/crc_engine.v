function [31:0] next_crc;
    ...
    input [7:0] d;
    begin
        next_crc[0] = c[24] ^ c[30] ^ d[0];
        next_crc[1] = c[24] ^ c[25] ^ c[30] ^ c[31] ^ d[1];
        next_crc[2] = c[24] ^ c[25] ^ c[26] ^ c[30] ^ c[31] ^ d[2];
        next_crc[3] = c[25] ^ c[26] ^ c[27] ^ c[31] ^ d[3];
        next_crc[4] = c[24] ^ c[26] ^ c[27] ^ c[28] ^ c[30] ^ d[4];
        next_crc[5] = c[24] ^ c[25] ^ c[27] ^ c[28] ^ c[29] ^ c[30] ^ c[31] ^ d[5];
        next_crc[6] = c[25] ^ c[26] ^ c[28] ^ c[29] ^ c[30] ^ c[31] ^ d[6];
        next_crc[7] = c[24] ^ c[26] ^ c[27] ^ c[29] ^ c[31] ^ d[7];
